...
while attemps<1234567890:
  ...
  if username =='vp' and password =='cyber'
      print('Incarect please carect Typ')
      attemps += 1
      continue 
...
╚══════╝╚═╝  ╚═╝╚═╝╚═╝  ╚═╝ ╚═════╝    ╚═╝       
 ...
 \033[1;93m**************************************************
 \033[1;93m|     \033[1;96m[ðŸ”°] CREATED BY\33[0;m   :  \033[1;96mSAIKOT VAI  \033[1;93m|
 \033[1;93m|     \033[1;32m[ðŸ”°] FACEBOK      : \033[1;34m saikotislam22  \033[1;93m|
 \033[1;93m|     \033[1;35m[ðŸ”°] GITHUB       :  \033[1;35mVP-CYBERG404  \033[1;93m|
...
def xak2(xak):
	for x in xak+"\n":
		...
		time.sleep(0.07)
os.system("clear")
os.system("ERROR\"Wall come sir, BD SMS booming loading  PLEASE WAIT \"")
...
try:
 ...
 os.system("ERROR  \"sir, Your Internet Connection Is Poblian PLEASE Chik\"")
...
print(' \033[1;93m**************************************************')
os.system("ERROR  \" Sir bombing start \"")
for i in range(amo):
	resp1 = requests.get(url1)
	print(f"{ran2}[SMS SENT SUCCESFULLY]ðŸ”° ")
	os.system("ERROR  \" Sir BD SMS booming SUCCESFULLY\"")
